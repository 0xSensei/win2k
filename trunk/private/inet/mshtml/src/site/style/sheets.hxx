...
public:
    ...
    unsigned long FindNestingLevel() const {
        unsigned long l = MAX_IMPORT_NESTING;
...
public:
    ...
    inline void Detach(void) {
        _pSelector = NULL; _dwSpecificity = 0;
...
public:
    ...
    HRESULT STDMETHODCALLTYPE GetNextDispID(DWORD grfdex, DISPID id, DISPID* prgid);
