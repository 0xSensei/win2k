...
STDMETHODIMP CFileStorage::CreateStorage(const OLECHAR* pwcsName, DWORD grfMode,
...
STDMETHODIMP CFileStorage::OpenStorage(const OLECHAR* pwcsName, IStorage* pstgPriority,
...
STDMETHODIMP CFileStorage::MoveElementTo(const OLECHAR* pwcsName, 
                                         IStorage* pstgDest,
...
STDMETHODIMP CFileStorage::SetElementTimes(const OLECHAR* pwcsName, 
