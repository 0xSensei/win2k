...
BOOL SIPObjectJAVA_::PutMessageInFile(SIP_SUBJECTINFO * pSI, WIN_CERTIFICATE * pWinCert, DWORD * pdwIndex)
{
...
BOOL SIPObjectJAVA_::GetDigestStream(DIGEST_DATA * pDigestData, DIGEST_FUNCTION pfnCallBack, DWORD dwFlags)
{
    return(JavaGetDigestStream(this->hFile, dwFlags, pfnCallBack, pDigestData));
}
