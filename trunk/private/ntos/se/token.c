...
Routine Description:
    ...
    supplied token to the TokenId field of the token from the current subject context.
Arguments:
...
Return Value:
    ...
    STATUS_ACCESS_DENIED - The thread handle is not open for impersonation access.
--*/
{
