...
ULONG LdrDoubleRelocateImage(IN PVOID NewBase,
...
PIMAGE_BASE_RELOCATION LdrpProcessVolatileRelocationBlock(IN ULONG_PTR VA,
    ...
    while (SizeOfBlock--) {
        ...
        case IMAGE_REL_BASED_HIGHADJ:
            ...
            *(PUSHORT)FixupVA = (USHORT)(Temp >> 16);
            ...
            if (ActualDiff == 1) {
                // Mark the relocation as needing an increment if it is relocated again.
        ...
        case IMAGE_REL_BASED_HIGH3ADJ:
            ...
            //  Adjust low half of high dword of an address and adjust for sign extension of the low dword.
...
--*/
{
    ...
    while (SizeOfBlock--) {
        ...
        case IMAGE_REL_BASED_HIGHADJ:
            ...
            // whether the entry was sign extended the 1st time it was relocated.
